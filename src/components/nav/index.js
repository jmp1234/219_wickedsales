...
function mapStateToProps(state) { //map component's state to redux props
  return {
    userAuth: state.user.auth
  }
}

export default connect(mapStateToProps)(Nav); //returns a function, and pass nav into that function's argument
